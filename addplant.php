  ...
  <body>'
    ...
    '<div class="form-container">
        ...
        <div class="form-card-body">
         <form class="plant-form" id="new-plant-form" action="process-new-plant.php" method="POST">
         ...
         <div class="input-group">
                ...
                <input type="text" id="plant-img" name="plant-img" placeholder="Leave blank for default picture">
            </div>
         </div>
    ...
    <div class="modal" id="modal">
        <div class="form-card new-plant">
            ...
            <div class="form-card-body">
                <form class="plant-type-form" action="add-plant-type.php" method="POST">
