  ...
  <body>'
    ...
    '<div class="form-container">
        ...
        <div class="form-card-body">
         <form class="plant-form" id="new-plant-form" action="process-new-plant.php">
         <div class="input-group-container">
            <div class="input-group">
                <label for="plant-name" id="name-label">Plant name</label>
                <input type="text" id="plant-name" placeholder="e.g. Tomato">
            </div>
            <div class="input-group">
                <label for="plant-cultivar" id="cultivar-label">Plant cultivar</label>
                <input type="text" id="plant-cultivar" placeholder="e.g. Cherry">
            </div>
         </div>
         <div class="input-group-container">
            <div class="input-group">
                <label for="date-planted" id="date-planted-label">Date planted</label>
                <input type="date" id="date-planted">
            </div>
            <div class="input-group">
                <label for="date-planted" id="proj-harvest-label">Projected harvest</label>
                <input type="date" id="projected-harvest">
            </div>
         </div>
         <div class="input-group-container">
         <div class="input-group">
                <label for="plant-img" id="img-url-label">Image URL</label>
                <input type="text" id="plant-img" placeholder="Leave blank for default picture">
            </div>
         </div>
